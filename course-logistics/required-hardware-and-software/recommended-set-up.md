...
{% hint style="info" %}
For Coding Basics, we recommend storing all of your code in a folder called `basics` as per the [recommended folder structure](https://thinklikeanengineer.gitbook.io/course-logistics/required-hardware-and-software/required-software-2#suggested-folder-structure-for-coding-basics), and keeping that folder open in VSCode for the duration of the course.
{% endhint %}
