...
Your game is working as intended, now it's time to make it look good! We'll edit index.html to personalise our game. If needed, review [1.2 Web Browsers](https://thinklikeanengineer.gitbook.io/o/1-introduction/1.2-web-browsers) on how to edit HTML.
